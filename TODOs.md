...
- Follow-up question: whether CrossOver/Elite needs true key-down/key-up timing or whether the current synthetic tap path is not being passed through to the game in this code path.
